...
const SkyMemoryGame: React.FC = () => {
  ...
  const settings =
    DIFFICULTY_SETTINGS[gameLevel as keyof typeof DIFFICULTY_SETTINGS] ||
    DIFFICULTY_SETTINGS[3];
    ...
    for (let i = 0; i < numGates; i++) {
      ...
      for (let j = 0; j < settings.sequenceLength; j++) {
        const availableColors =
          j < settings.colors
            ? SKY_COLOR_PALETTE.slice(0, settings.colors)
            : SKY_COLOR_PALETTE;
        const colorConfig =
    ...
    if (state === "PLAYING") {
      ...
      for (let i = gatesRef.current.length - 1; i >= 0; i--) {
        ...
        if (state === "PLAYING" && birdRef.current) {
          ...
          if (
            gate.state === "waiting" ||
            gate.state === "passed_checkpoint" ||
            gate.state === "showing"
          ) {
            const gapTop =
              gate.pillarTops.length > 0 ? gate.pillarTops[0] : c.height * 0.3;
            const gapBottom =
              gate.pillarBottoms.length > 0
                ? gate.pillarBottoms[0]
                : c.height * 0.7;
  ...
  const handleSaveAndExit = async () => {
    try {
      ...
      const accuracy = calculateCognitiveAccuracy(
        m.correctCheckpoints,
        m.correctCheckpoints + m.wrongCheckpoints,
      );
      ...
      await saveGameSession({
        ...
        gameId: "sky_memory",
        level: Number.isFinite(gameLevel) ? gameLevel : 3,
  ...
  const pInfo = {
    hex:
      pressDisp < IDLE_THRESHOLD
        ? "#64748b"
        : pressDisp < DANGER_THRESHOLD * 0.6
          ? "#2DD4BF"
          : pressDisp < DANGER_THRESHOLD * 0.85
            ? "#FACC15"
            : "#EF4444",
    label:
      pressDisp < IDLE_THRESHOLD
        ...
        <div
          ...
          <div
            style={{
              ...
              boxShadow:
                "0 0 70px rgba(139,92,246,0.2),0 32px 80px rgba(0,0,0,0.60)",
              position: "relative",
              overflow: "hidden",
            }}>
            <div
              style={{
                ...
                height: "32%",
                background:
                  "linear-gradient(to bottom,transparent,rgba(167,139,250,0.04),transparent)",
            ...
            <h1
              style={{
                ...
                margin: "0 0 5px",
                textShadow: "0 0 28px rgba(167,139,250,0.50)",
              }}>
            ...
            <div
              ...
              <div
                ...
                <div
                  ...
                  <Hand size={17} style={{ color: "#A78BFA" }} />
                  <span
                ...
                {isConnected ? (
                  ...
                  <>
                    <p
                      ...
                      Hold <strong style={{ color: "#A78BFA" }}>SPACE</strong>{" "}
                      to fly up.
                    </p>
                    <p
                      style={{
                    ...
                    <p
                      ...
                      Connect device for hardware mode
                    </p>
                  </>
                )}
              </div>
              <div
                ...
                <div
                  ...
                  <Brain size={17} style={{ color: "#F472B6" }} />
                  <span
                    style={{ color: "#fff", fontWeight: 700, fontSize: 12 }}>
                    GOAL
                  </span>
                ...
                <p
                  ...
                  Pass through in the{" "}
                  <span style={{ color: "#F472B6" }}>correct order</span>!
                </p>
              </div>
            </div>
            ...
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                boxShadow: "0 0 38px rgba(139,92,246,0.50)",
                display: "inline-flex",
                alignItems: "center",
                gap: 11,
        ...
        <div
          ...
          <div
            style={{
              ...
              padding: "38px 48px",
              textAlign: "center",
              boxShadow: "0 0 44px rgba(239,68,68,0.15)",
            ...
            <div
              ...
              <div
                ...
                <span
                  style={{ color: "#FACC15", fontWeight: 700, fontSize: 14 }}>
                  {streak}
                </span>
              </div>
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                ...
                <span
                  style={{ color: "#22C55E", fontWeight: 700, fontSize: 14 }}>
                  {level}
                </span>
              </div>
            </div>
          ...
          <div
            ...
            <div
              ...
              <div
                ...
                <Target
                  size={13}
                  style={{ color: streak > 2 ? "#F472B6" : "#4B5563" }}
                />
                <span
                  style={{
                    fontSize: 24,
                    fontWeight: 900,
                    color: streak > 2 ? "#F472B6" : "#fff",
          ...
          {false && (
            <div
              style={{
                ...
                transform: "translateX(-50%)",
                zIndex: 35,
                animation: "hudin 0.3s ease both",
              }}>
              <div
                style={{
      ...
      {uiCd !== null && (
        <div
          style={{
            ...
            fontWeight: 900,
            color: uiCd === "GO!" ? "#A78BFA" : "#A78BFA",
            textShadow: `0 0 55px ${uiCd === "GO!" ? "rgba(139,92,246,0.80)" : "rgba(167,139,250,0.80)"}`,
            animation:
              uiCd === "GO!"
