// lib/db/assignments.ts
// Helpers for the `assignments` collection.
// Assignments are tasks a doctor creates for a patient —
// e.g. "Play Rhythm Reef for 15 mins, focus on smooth grip release."
//
// Firestore indexes required:
// 1. assignments | patientId ASC, assignedDate DESC
// 2. assignments | doctorId  ASC, assignedDate DESC
// 3. assignments | patientId ASC, status ASC, assignedDate DESC
