...
export const seedDatabase = async () => {
  try {
    ...
    if (!patientId) {
      alert("Please sign in as a patient before seeding data.");
      return;
    }
    ...
    await setDoc(doc(db, "protocols", protocolId), {
      ...
      sessionsPerWeek: 5,
      doctorNote:
        "Focus on consistent grip pressure. Avoid overexertion in final third of session.",
      settings: {
        difficulty: "medium",
        gripMvcPercent: 45,
        audioHints: true,
    ...
    console.log("✅ Protocol created:", protocolId);
    ...
    const sessionData = [
      {
        ...
        aiSummary:
          "Baseline session. High fatigue drop observed in final third.",
      },
      {
        date: daysAgo(9),
        ...
        aiSummary:
          "Left hand reference session. Strong baseline for bilateral comparison.",
      },
      {
        date: daysAgo(8),
        targetHand: "right" as const,
        ...
        aiSummary:
          "Marginal improvement in peak force. Endurance still elevated.",
      },
      {
        date: daysAgo(7),
        targetHand: "right" as const,
      ...
      },
      {
        ...
        aiSummary:
          "First time exceeding 1.0 kPa peak. Strong milestone session.",
      },
      {
        date: daysAgo(3),
        targetHand: "right" as const,
        ...
        aiSummary:
          "Excellent consistency. Endurance drop reducing significantly.",
      },
      {
        date: daysAgo(2),
        targetHand: "right" as const,
        ...
        aiSummary:
          "Consistent improvement trajectory. Protocol level-up candidate.",
      },
      {
        date: daysAgo(1),
        targetHand: "right" as const,
        ...
        aiSummary:
          "Best session to date. Peak grip 1.24 kPa, near-zero endurance drop.",
      },
    ];
    ...
    await addDoc(commsRef, {
      ...
      content:
        "John, I reviewed your session data and I'm very impressed. Your grip strength has improved from 0.82 to 1.24 kPa over 10 days — a 51% improvement. Your endurance drop has also reduced from 28% to near zero. Keep up the current protocol.",
    ...
    await addDoc(commsRef, {
      ...
      content:
        "Based on your consistent performance above 1.0 kPa, I'm unlocking Level 3 starting next week. Increase session duration target to 20 minutes. If you experience any discomfort in the forearm, reduce to Level 2 immediately and message me.",
    ...
    await addDoc(commsRef, {
      ...
      content:
        "Your right hand (affected) is now at 1.12 kPa vs left hand at 1.18 kPa — a symmetry ratio of 95%. This is excellent recovery progress for a stroke patient at this stage.",
