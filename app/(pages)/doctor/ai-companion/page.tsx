...
const QUICK_ACTIONS = [
    { label: "Weekly cohort summary",      icon: BarChart3,      mode: "weekly_summary" as const, color: "text-blue-600 bg-blue-50 border-blue-200 hover:bg-blue-100 dark:text-blue-400 dark:bg-blue-900/20 dark:border-blue-700 dark:hover:bg-blue-900/30" },
    { label: "Who needs attention?",        icon: AlertTriangle,  mode: "triage" as const,         color: "text-amber-600 bg-amber-50 border-amber-200 hover:bg-amber-100 dark:text-amber-400 dark:bg-amber-900/20 dark:border-amber-700 dark:hover:bg-amber-900/30" },
    { label: "Grip strength trends",        icon: TrendingUp,     mode: "chat" as const,           color: "text-teal-600 bg-teal-50 border-teal-200 hover:bg-teal-100 dark:text-teal-400 dark:bg-teal-900/20 dark:border-teal-700 dark:hover:bg-teal-900/30" },
    { label: "Protocol optimisation tips",  icon: Stethoscope,    mode: "chat" as const,           color: "text-purple-600 bg-purple-50 border-purple-200 hover:bg-purple-100 dark:text-purple-400 dark:bg-purple-900/20 dark:border-purple-700 dark:hover:bg-purple-900/30" },
    { label: "Adherence breakdown",         icon: Activity,       mode: "chat" as const,           color: "text-teal-600 bg-teal-50 border-teal-200 hover:bg-teal-100 dark:text-teal-400 dark:bg-teal-900/20 dark:border-teal-700 dark:hover:bg-teal-900/30" },
    { label: "Device health check",         icon: Shield,         mode: "chat" as const,           color: "text-blue-600 bg-blue-50 border-blue-200 hover:bg-blue-100 dark:text-blue-400 dark:bg-blue-900/20 dark:border-blue-700 dark:hover:bg-blue-900/30" },
];
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-6">
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        <h2 className="text-[#0A2E4C] dark:text-slate-100 text-2xl font-bold tracking-tight">Clinical AI</h2>
                    ...
                    <p className="text-gray-500 dark:text-slate-400 text-sm">Clinical decision support · Real-time cohort analysis · Powered by Gemini</p>
                </div>
                ...
                <div className="grid gap-5 lg:grid-cols-[1fr_300px]">
                    ...
                    <div className="bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 shadow-sm rounded-2xl flex flex-col h-[calc(100vh-220px)] overflow-hidden">
                            ...
                            {messages.length === 0 && !isLoading && (
                                <div className="flex flex-col items-center justify-center h-full gap-4">
                                    ...
                                    <div className="text-center">
                                        <p className="text-[#0A2E4C] dark:text-slate-100 font-semibold text-base">Clinical AI ready.</p>
                                        <p className="text-gray-400 dark:text-slate-500 text-sm mt-1 max-w-xs">Ask about your cohort, patient adherence, or protocol recommendations.</p>
                                    </div>
                        ...
                        <div className="p-4">
                            ...
                            <p className="text-center text-gray-300 dark:text-slate-600 text-xs mt-2">Clinical support tool · Not a substitute for professional medical judgment.</p>
                        </div>
                    </div>
