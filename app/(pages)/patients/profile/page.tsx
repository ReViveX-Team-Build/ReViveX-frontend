...
const CSS = `
  ...
  .dark .pf [style*="background:#fff"],
  .dark .pf [style*="background: #fff"],
  .dark .pf [style*="background:#f8fafc"],
  .dark .pf [style*="background: #f8fafc"],
  .dark .pf [style*="background:'#F0F4F8'"],
  .dark .pf [style*="background: '#F0F4F8'"] {
    background:#0f172a !important;
  }

  .dark .pf [style*="color:#0B1E33"],
  .dark .pf [style*="color: #0B1E33"] {
    color:#e2e8f0 !important;
  }

  .dark .pf [style*="color:#64748b"],
  .dark .pf [style*="color: #64748b"],
  .dark .pf [style*="color:#94a3b8"],
  .dark .pf [style*="color: #94a3b8"] {
    color:#94a3b8 !important;
  }

  .dark .pf [style*="border:1px solid rgba(226,232,240"],
  .dark .pf [style*="border: 1px solid rgba(226,232,240"],
  .dark .pf [style*="border:1.5px solid rgba(226,232,240"],
  .dark .pf [style*="border: 1.5px solid rgba(226,232,240"] {
  ...
  .dark .pf .pf-input::placeholder {
    color:#64748b !important;
  }

  .dark .pf .sep,
  .dark .pf .xp-bar-track {
      ...
      <div
        ...
        <div
          ...
          <div
            ...
            style={{
              fontSize: 9,
              color: isDark ? "#94a3b8" : "rgba(45,212,191,0.6)",
              letterSpacing: ".38em",
      ...
      <main
        ...
        <div
          ...
          <div style={{ position: "relative", zIndex: 2 }}>
            ...
            <p
              ...
              <span style={{ color: "#2DD4BF", fontWeight: 700 }}>
                {draft.unlockedLevels.length} levels
              </span>{" "}
              unlocked ·{" "}
          ...
          <button
            ...
            onMouseLeave={(e) =>
              (e.currentTarget.style.borderColor = "rgba(11,30,51,0.12)")
            }>
        ...
        <div
          ...
          style={{
            ...
            gap: 24,
            flexWrap: "wrap",
            animation: "cardPop 0.55s cubic-bezier(0.22,1,0.36,1) 0.05s both",
            position: "relative",
            overflow: "hidden",
          }}>
          <div
          ...
          <div style={{ position: "relative", flexShrink: 0 }}>
            ...
            <button
              ...
              onMouseLeave={(e) =>
                (e.currentTarget.style.background = "#0B1E33")
              }>
          ...
          <div style={{ flex: 1, minWidth: 220 }}>
            ...
            <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
              {[
                ...
                {
                  icon: <Brain size={12} />,
                  val: draft.unlockedLevels.length,
                  label: "Levels",
                  c: "#8b5cf6",
                },
                {
                  icon: <Activity size={12} />,
                  val: draft.completedSessions,
                  label: "Sessions",
                  c: "#22c55e",
                },
              ].map((s) => (
                <div key={s.label} className="stat-chip">
                  ...
                  <span
                    style={{ fontSize: 13, fontWeight: 800, color: "#0B1E33" }}>
                    {s.val}
                  </span>
                  <span
                    className="mono"
        ...
        <div
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            <div
              ...
              style={{
                padding: 28,
                animation:
                  "cardPop 0.55s cubic-bezier(0.22,1,0.36,1) 0.13s both",
              }}>
              ...
              <textarea
                ...
                value={draft.goals}
                onChange={set("goals")}
                placeholder="What do you want to achieve with ReViveX?"
              />
            </div>
            ...
            <div
              ...
              <textarea
                ...
                value={draft.bio}
                onChange={set("bio")}
                placeholder="Tell your care team a little about yourself…"
              />
            </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            <div
              style={{
                animation:
                  "cardPop 0.55s cubic-bezier(0.22,1,0.36,1) 0.11s both",
                background: "#0B1E33",
                borderRadius: 22,
              ...
              <div style={{ position: "relative", zIndex: 2 }}>
                ...
                <div
                  ...
                  <span
                    className="mono"
                    style={{ fontSize: 8, color: "#2DD4BF", fontWeight: 700 }}>
                    {draft.totalXp} / {XP_CAP}
                  </span>
                </div>
                ...
                <div
                  ...
                  <span
                    ...
                    {draft.unlockedLevels.length}/5 LEVELS
                  </span>
                  <span
                    className="mono"
                    style={{
                    ...
                    {draft.completedSessions} SESSIONS
                  </span>
                </div>
              </div>
            </div>
            ...
            <div
              ...
              {[
                {
                  ...
                  label: "Assigned Protocol",
                  val: draft.assignedProtocol,
                  c: "#2DD4BF",
                },
                {
                  icon: <Calendar size={15} />,
                  label: "Next Appointment",
                  val: draft.nextAppointment,
                  c: "#8b5cf6",
                },
                {
                  icon: <Heart size={15} />,
                  label: "Condition",
                  val: draft.condition || "Not set",
                  c: "#ef4444",
                },
              ].map((item) => (
                <div
              ...
              {draft.joinedAt && (
                <div
                  ...
                  MEMBER SINCE ·{" "}
                  {new Date(draft.joinedAt).toLocaleDateString("en-US", {
                    month: "long",
                    year: "numeric",
                  })}
                </div>
                    ...
                    <div
                      ...
                      <div
                        style={{
                          ...
                          height: 6,
                          borderRadius: "50%",
                          background: done ? "#2DD4BF" : "#e2e8f0",
                          boxShadow: done ? "0 0 7px #2DD4BF" : "none",
                        }}
                      />
                    </div>
                  );
