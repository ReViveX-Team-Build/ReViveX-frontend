...
const BASE_LEVELS: Level[] = [
  {
    ...
    category: "MOTOR",
    desc: "Baseline calibration and introductory motor control. Establishes your squeeze-force baseline.",
    locked: false,
  ...
  },
  {
    ...
    category: "MOTOR",
    desc: "Advanced grip timing and fine coordination. Navigate tight curves with precise pressure.",
    locked: false,
